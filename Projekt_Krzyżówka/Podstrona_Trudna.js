...
btn.addEventListener('click', function() {
    ...
    const tablica_pierwszej_odpowiedzi_gracza_Duze_Litery = tablica_pierwszej_odpowiedzi_gracza.map(function(elementy_tablicy) {
        return elementy_tablicy.toUpperCase();
    });
    ...
    const tablica_drugiej_odpowiedzi_gracza_Duze_Litery = tablica_drugiej_odpowiedzi_gracza.map(function(elementy_tablicy) {
        return elementy_tablicy.toUpperCase();
    });
    ...
    const tablica_trzeciej_odpowiedzi_gracza_Duze_Litery = tablica_trzeciej_odpowiedzi_gracza.map(function(elementy_tablicy) {
        return elementy_tablicy.toUpperCase();
    });
    ...
    const tablica_czwartej_odpowiedzi_gracza_Duze_Litery = tablica_czwartej_odpowiedzi_gracza.map(function(elementy_tablicy) {
        return elementy_tablicy.toUpperCase();
    });
    ...
    const tablica_piatej_odpowiedzi_gracza_Duze_Litery = tablica_piatej_odpowiedzi_gracza.map(function(elementy_tablicy) {
        return elementy_tablicy.toUpperCase();
    });
      ...
      const tablica_szostej_odpowiedzi_gracza_Duze_Litery = tablica_szostej_odpowiedzi_gracza.map(function(elementy_tablicy) {
          return elementy_tablicy.toUpperCase();
    });
    ...
    if(odpjeden===2)
    {
        document.getElementById("wynik1").textContent = "Odpowiedz numer 1 w krzyzówce jest błędna";

    }
    else
    {
        var twoja_odpowiedz = tablica_pierwszej_odpowiedzi_gracza_Duze_Litery[0];
        document.getElementById("wynik1").textContent = "";
    ...
    if(odpdwa===2)
    {
        document.getElementById("wynik2").textContent = "Odpowiedz numer 2 w krzyzówce jest błędna";
    }
    else
    {
    ...
    if(odptrzy===2)
    {
        document.getElementById("wynik3").textContent = "Odpowiedz numer 3 w krzyzówce jest błędna";
    }
    else
    {
    ...
    if(odpcztery===2)
    {
        document.getElementById("wynik4").textContent = "Odpowiedz numer 4 w krzyzówce jest błędna";
    }
    else
    {
        var twoja_odpowiedz4 = tablica_czwartej_odpowiedzi_gracza_Duze_Litery[1];
        document.getElementById("wynik4").textContent = "";
    ...
    if(odppiec===2)
    {
        document.getElementById("wynik5").textContent = "Odpowiedz numer 5 w krzyzówce jest błędna";
    }
    else
    {
        var twoja_odpowiedz2 = tablica_piatej_odpowiedzi_gracza_Duze_Litery[4];
        document.getElementById("wynik5").textContent = "";
